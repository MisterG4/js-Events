...
function lessContent(){
	...
	noMore.appendChild(less);

}

// another way: less.style.display = "none";
...
var menuItems = [" Big Mac", " Large Fries",  " Filet-O-Fish"];

//showMenu.addEventListener("click", valueMenu);
function valueMenu(){
	showMenu.innerHTML = menuItems;
...
//oreo.addEventListener("onmouseover", showPrice);
	function showPrice(){
		price.innerHTML = "$5.55";
		//price.appendChild(showPrice);
}
